...
In games, integer variables are assumed to be initialized to $0$, set variables to the empty set, and Boolean variables to $\false$. %string variables to the empty string, and tables are initially empty.
